...
const (
	DataService_Send_FullMethodName = "/DataService/Send"
)
...
type DataServiceClient interface {
	Send(ctx context.Context, in *DataMessage, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *dataServiceClient) Send(ctx context.Context, in *DataMessage, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type DataServiceServer interface {
	Send(context.Context, *DataMessage) (*emptypb.Empty, error)
...
func (UnimplementedDataServiceServer) Send(context.Context, *DataMessage) (*emptypb.Empty, error) {
...
func _DataService_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataServiceServer).Send(ctx, req.(*DataMessage))
	}
